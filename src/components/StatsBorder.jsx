...
const StatsBorder = ({viewingStats}) => {
  ...
  return (
    <>
      <div className="w-[288.5px] h-[1px] bg-white absolute bottom-[70.5px] right-0 opacity-45"  id="bottom_line"></div>
      ...
      <div className="w-[1px] h-[36.68vh] bg-white absolute top-0 right-[41px] opacity-45"></div>
      <div className="w-[1px] h-[19vh] bg-white absolute top-[40.5vh] right-[72px] opacity-45" id="mid_line"></div>
      <div className="w-[1px] h-[36.68vh] bg-white absolute bottom-0 right-[41px] opacity-45"></div>
    </>
  );
};
